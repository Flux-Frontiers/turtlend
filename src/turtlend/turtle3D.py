...
from turtlend.vector3D import Vector3D as Vector
...
class Turtle3D:
    ...
    def unit(self, v: numpy.ndarray) -> numpy.ndarray:
        """
    ...
    def orient(self, position: numpy.ndarray, heading: numpy.ndarray, left: numpy.ndarray) -> None:
        """
    ...
    def to_local(self, global_vec) -> numpy.ndarray:
        """
    ...
    def to_global(self, local) -> numpy.ndarray:
        """
